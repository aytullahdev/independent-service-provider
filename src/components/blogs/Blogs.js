...
const Blogs = () => {
    return (
        <div>
            ...
            <div className='text-left p-5'>
                <h1 className='text-xl font-semibold '> Why are you using firebase? What other options do you have to implement authentication?</h1>
                <p className='py-2  text-gray-500'>
            ...
            <div className='text-left p-5'>
                <h1 className='text-xl font-semibold '> What other services does firebase provide other than authentication?</h1>
                <p className='py-2  text-gray-500'>
